...
@section('title', 'administrador: ' . auth()->user()->usuario_dato->ud_nom)  


@section('content')

<h1>Bienvenido usuario administrador {{ $admin->ud_nom }} {{ $admin->ud_app }}</h1>
<div class="col ">
...
<div class="col ">
    ...
    @include('layauts.vistas',['pagina'=>'inicio.admin'])
@endsection
